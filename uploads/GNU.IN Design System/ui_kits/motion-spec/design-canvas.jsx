...
if (typeof document !== 'undefined' && !document.getElementById('dc-styles')) {
  ...
  '.dc-card{scrollbar-width:thin;scrollbar-color:rgba(0,0,0,.18) transparent}',
  '.dc-card::-webkit-scrollbar{width:6px;height:6px}',
  '.dc-card::-webkit-scrollbar-track{background:transparent}',
  '.dc-card::-webkit-scrollbar-thumb{background:rgba(0,0,0,.18);border-radius:3px}',
  '.dc-card::-webkit-scrollbar-thumb:hover{background:rgba(0,0,0,.32)}',
...
function DCArtboardFrame({ sectionId, artboard, label, order, onRename, onReorder, onFocus }) {
  ...
  return (
    <div ref={ref} data-dc-slot={id} style={{ position: 'relative', flexShrink: 0 }}>
      ...
      style={{ borderRadius: 2, boxShadow: '0 1px 3px rgba(0,0,0,.08),0 4px 16px rgba(0,0,0,.06)', overflow: 'auto', width, height, background: '#fff', ...style }}>
