...
//   ◆.5 API surface       · public symbols typed across QML / Qt / GPUI

/* ════════════════════════════════════════════════════════════════════
   ◆.3 — Repo & file layout
   Three columns : Quickshell (QML), Qt C++, GPUI (Rust). Same shape,
...
const REPO_TREES = {
  ...
  gpui: [
    ...
    { d: 1, name: 'lib/' },
    { d: 2, name: 'gnu_theme.gpui.rs', tag: 'tokens' },
    { d: 2, name: 'theme/' },
    { d: 3, name: 'gnu_theme.rs' },
    { d: 3, name: 'tokens.rs' },
    { d: 2, name: 'primitives/' },
    { d: 3, name: 'gnu_row.rs' },
    { d: 3, name: 'gnu_shell.rs' },
    { d: 3, name: 'gnu_toggle.rs' },
    { d: 3, name: '…  ·  21 autres' },
    { d: 2, name: 'molecules/' },
    { d: 3, name: 'gnu_section.rs' },
    { d: 3, name: '…  ·  15 autres' },
    { d: 2, name: 'recipes/' },
    { d: 3, name: 'empty_space_menu.rs' },
    { d: 3, name: 'bubble_tree_menu.rs' },
    { d: 1, name: 'assets/' },
    { d: 2, name: 'tokens.json',  tag: 'shared' },
...
function CtxHandoffRepo() {
  ...
  const titles = [
    ...
    { k: 'gpui', label: 'GPUI',       sub: 'gnu_in_shell · Rust/GPUI' },
  ];
  return (
...
const SPRINTS = [
  {
    ...
    deliverables: [
      ...
      'générateur : tokens.json → gnu_theme.gpui.rs / .h (+ GnuTheme.qml opt-in)',
  ...
  },
  {
    ...
    gate: 'parité visuelle 100 % vs la fiche · QML/Qt/GPUI pixel-diff < 1 px',
  },
  {
    n: '03', code: 'CONTRACTS',
...
/* ════════════════════════════════════════════════════════════════════
   ...
   across QML / Qt / GPUI. Compile-target view — what a dev sees
...
function CtxHandoffApi() {
  ...
  const engines = [
    ...
    { k: 'gpui', label: 'GPUI', color: '#3D8DCC' },
  ];
  return (
