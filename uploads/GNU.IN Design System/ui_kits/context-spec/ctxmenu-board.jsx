      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', inset: 60, display: 'flex', flexDirection: 'column', gap: 24 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <div>
              <div style={{ fontSize: 11, color: '#FF6A00', fontWeight: 700, letterSpacing: '0.18em', fontFamily: 'ui-monospace, monospace' }}>GNU.IN-SHELL · CONTEXT SPEC v0.14.0</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 32, marginTop: 14, flex: 1 }}>
            <div>
              ...
              <div style={{ marginTop: 22, display: 'flex', gap: 10, fontSize: 10, fontFamily: 'ui-monospace, monospace', flexWrap: 'wrap' }}>
                {['NEU · tokens', 'CSS · web ref', 'QML · Quickshell', 'QT · C++', 'GPUI · Rust'].map((t) =>
            ...
            <div style={{ background: 'rgba(255,255,255,.04)', borderRadius: 12, padding: 20, border: '.5px solid rgba(255,255,255,.06)' }}>
              <div style={{ fontSize: 10, color: '#FF6A00', fontWeight: 700, letterSpacing: '0.14em', fontFamily: 'ui-monospace, monospace', marginBottom: 14 }}>INVENTAIRE · v0.14.0</div>
              {[
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, fontSize: 11, color: 'rgba(247,243,237,.5)', fontFamily: 'ui-monospace, monospace', letterSpacing: '0.06em' }}>
            <span style={{ padding: '4px 10px', borderRadius: 3, background: 'rgba(255,106,0,.15)', color: '#FF6A00', fontWeight: 700 }}>CONTEXT SPEC v0.14.0</span>
            <span>compagnon du Motion Spec v0.14.0 · même grammaire d'atomes</span>
            <span style={{ marginLeft: 'auto' }}>2026.06 · cible : Quickshell · Qt 6.6 · GPUI/Rust</span>
          </div>
        </div>
      </div>
    </FitScale>);
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 28, marginTop: 36 }}>
          ...
          { n: '01', label: 'ATOMES (12)', kw: 'row · kbd · chevron · toggle · swatch',
            ...
            detail: 'Pour chaque atome : démo isolée + tokens + snippet QML / Qt / GPUI / CSS. Lit-toi du bas vers le haut quand tu construis un nouveau menu.' },
      ...
      <div style={{ width: 1280, height: 720, background: '#0B0D10', color: '#F7F3ED', padding: 60, boxSizing: 'border-box', fontFamily: 'ui-sans-serif, system-ui, sans-serif', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <div style={{ marginTop: 32, display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 22 }}>
            {[
            { n: '01', label: 'TOKENS', title: 'gnu_theme.{gpui.rs,h,qml}',
              steps: [
              'blobin-gen tokens.json → 3 cibles (Rust/C++ first)',
              'output 1 : gnu_theme.gpui.rs (GPUI Rgba + motion Duration)',
              'output 2 : gnu_theme.h (C++ constexpr — PRIMARY)',
              'output 3 : GnuTheme.qml (opt-in Qt/Quickshell uniquement)',
              'tests : hex roundtrip identique sur les trois sorties']
            },
          ...
          <div style={{ marginTop: 'auto', position: 'absolute', bottom: 32, left: 60, right: 60, display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: 11, color: 'rgba(247,243,237,.5)', fontFamily: 'ui-monospace, monospace', letterSpacing: '0.06em' }}>
            <span>GNU.IN-SHELL · CONTEXT SPEC v0.14.0 · 2026.06</span>
            <span>brancher la motion-spec : Motion Spec v0.14.0 ↔ Context Spec v0.14.0 partagent les atomes</span>
          </div>
        </div>
      </div>
    </FitScale>);
