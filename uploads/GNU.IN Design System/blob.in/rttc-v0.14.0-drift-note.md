...
design_source: "Context.Spec v0.14.0 · Motion Spec v0.14.0"
role: "Bump RTTC existants de v1 → v0.14.0 · delta structurel"
---

# RTTC Drift Note — Context.Spec v1 → v3.1 (renuméroté v0.14.0)

> **Renumbering (2026-06-08)** — la version dite « v3.1 » dans ce document a été
> renumérotée **v0.14.0** pour suivre le semver du moteur blob.in. Les tables
> ci-dessous gardent l'étiquette historique « v3.1 » (c'est le delta réel qui a
> mené à l'état courant) ; « v3.1 » ≡ « v0.14.0 » partout ici.
>
> Les `.rttc.md` existants dans `components/` ont été écrits contre **Context.Spec v1**
> (2026-05-16). La spec de référence est maintenant à **v0.14.0** (ex-v3.1).
