        ...
        return (
          <div style={{ position: 'absolute', inset: 0, background: INK }}>
            ...
            <Sprite start={9.5} end={63.5}>{({ progress }) => (
              <div style={{ position: 'absolute', left: W - 300, top: 470, opacity: clamp(progress * 4, 0, 1) }}>
                <Mascot x={0} y={0} size={170} state={mascotState} t={lt} />
              </div>
            )}</Sprite>
        ...
        return (
          <div style={{ position: 'absolute', inset: 0 }}>
            ...
            <div style={{ position: 'absolute', left: 70, top: 1080, width: W - 140, opacity: clamp(progress * 3, 0, 1) }}>
              ...
              <div style={{ font: `400 24px ${MONO}`, color: '#9aa0a8', marginTop: 28 }}>&gt;_ gnu.in-shell · v0.12.0</div>
            </div>
          </div>
        );
      }}
