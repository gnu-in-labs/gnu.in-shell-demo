...
const MOLECULE_SPECS = {
  "spec": "molecule-specs",
  "role": "SINGLE SOURCE OF TRUTH for the 27 context-menu molecules, expressed as ENGINE SCENE-GRAPH COMPOSITIONS (not bespoke JSX). Each molecule is data the engine's reduce() lays out into a Scene the host paints. Central, the gallery, and the Rust host all consume THIS — killing the double-implementation (JSX demo + hand-built host).",
  "resolves": {
  ...
  "consumers": {
    ...
    "central": "AgenticGnuContextMenu (agentic-panel) is the canonical spec for GnuContextMenu — Central's bespoke JSX should be replaced by this data record",
    "gallery": "MoleculeRenderer covers all 30 molecules (0 bespoke code) — agentic family (08) now catalogued"
  }
}
;
function DataGallery() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:pageBg, color:pageFg, fontFamily:'ui-sans-serif,system-ui,sans-serif', padding:'24px 30px 64px', transition:'background .2s, color .2s' }}>
